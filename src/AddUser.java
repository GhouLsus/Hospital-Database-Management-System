...
public class AddUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 75, 850, -1));
        ...
        comboUserRole.setFont(new java.awt.Font("Times New Roman", 0, 12)); // NOI18N
        ...
        getContentPane().add(comboUserRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 170, 299, -1));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, 299, -1));

        dateDOB.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(dateDOB, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 299, -1));
        ...
        getContentPane().add(txtMobileNumber, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 370, 299, -1));

        jLabel6.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel6.setText("Email");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 150, -1, -1));

        txtEmail.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(txtEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 170, 299, -1));
        ...
        getContentPane().add(txtUsername, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 230, 299, -1));

        iconLabel.setText("jLabel8");
        getContentPane().add(iconLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 220, -1, 20));

        jLabel9.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel9.setText("Password");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 280, -1, -1));

        txtPassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 300, 299, -1));

        jLabel10.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        jLabel10.setText("Address");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 350, -1, -1));

        txtAddress.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        getContentPane().add(txtAddress, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 370, 299, -1));

        txtSave.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        txtSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/save-file.png"))); // NOI18N
        txtSave.setText("Save");
        txtSave.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        txtSave.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtSaveActionPerformed(evt);
            }
        });
        getContentPane().add(txtSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(334, 432, 103, -1));
    ...
    private void txtSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSaveActionPerformed
        ...
        try{
            ...
            ps.executeUpdate();
            JOptionPane.showMessageDialog(null, "User added succesfuly");
            setVisible(false);
